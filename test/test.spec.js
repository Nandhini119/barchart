...
let json1 = require('../test/json/Literacy_All_states_json');
let json2 = require('../test/json/Literacy_Ratio_India_json');
let json3 = require('../test/json/Literacy_Ratio_NE_states_json');
let jsondiff = require('../test/jsondiff.js');
